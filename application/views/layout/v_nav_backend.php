...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<div class="sidebar">
		...
		<div class="user-panel mt-3 pb-3 mb-3 d-flex">
			<div class="image">
				<img src="<?= base_url() ?>template/dist/img/admin.jpg" class="img-circle elevation-2" alt="User Image">
			</div>
			<div class="info">
		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
			   ...
			   with font-awesome or any other icon font library -->
				...
				<li class="nav-item">
					<a href="<?= base_url('kendaraan')  ?>" class="nav-link <?php if ($this->uri->segment(1) == 'kendaraan') {
																				echo "active";
																			} ?>">
				...
				<li class="nav-item">
					<a href="<?= base_url('gambarkendaraan')  ?>" class="nav-link <?php if ($this->uri->segment(1) == 'gambarkendaraan') {
																					echo "active";
																				} ?>">
			...
			<?php
if($this->session->userdata('level_user') == '1'){ // Jika role-nya admin
    ?>
				<li class="nav-item">
